...
<body>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="producer_item">
                        <div id="rrrr" onmouseover="hoverEffect(this)" onmouseout="normalEffect(this)">
                            <img  class="producer_logo"  src="{{asset('assets/images/producer_logo.png')}}" alt="">
                            <div id="producer_item_content" class="producer_item_content">
    ...
    <script>
        function hoverEffect(){
            document.getElementById('producer_item_content').style.display = 'block'
        }
        function normalEffect(){
            document.getElementById('producer_item_content').style.display = 'none'
        }
    </script>
</body>
</html>
